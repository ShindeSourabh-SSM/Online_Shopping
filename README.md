...
Step 2: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```(https://github.com/ShindeSourabh-SSM/Online_Shopping/)```> Select master Branch > Next > Next > Finish.
