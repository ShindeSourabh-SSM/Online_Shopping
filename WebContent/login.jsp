...
<body style="background: #34e89e;  /* fallback for old browsers */
	...
	<div class="container">
		<div class="row"
			...
			<form action="./LoginSrv" method="post"
				...
				style="border: 2px solid black; border-radius: 10px; background: #8360c3;  /* fallback for old browsers */
background: -webkit-linear-gradient(to right, #2ebf91, #8360c3);  /* Chrome 10-25, Safari 5.1-6 */
background: linear-gradient(to right, #2ebf91, #8360c3);; padding: 10px;">
				<div style="font-weight: bold;" class="text-center">
					<h2 style="background: #1c92d2;  /* fallback for old browsers */
